...
namespace session
{
    class TCP
    {
        private string serverIp = "smartSwitch.local"; 
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            curve25519.GenerateKeypair(publickey, privatekey);
            ...
            {
                Type = MessageType.NewSecuritySession,
                RelayNumber = 1,
                RelayState = RelayState.TurnOff,

                Sec1 = new Sec1Payload
                {
                    Sc0 = new SessionCmd0
                    {
                        ClientPubkey = ByteString.CopyFrom(publickey),
                    }
                }
            };
            ...
            tcp.SendTcpMessage(payloadBytes);

            PrintByteArrayInHex(publickey);

        }
        static void PrintByteArrayInHex(byte[] byteArray)
        {
    ...
    public class Curve25519
    {
        ...
        public void ScalarmultBase(byte[] output, byte[] scalar)
        {
